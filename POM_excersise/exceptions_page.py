...
class ExceptionsPage(BasePage):
    ...
    _row1_edit_button = (By.ID, "edit_btn")
    __confirm_element = (By.ID, "confirmation")
    ...
    def add_second_food(self, food: str):
        ...
        super()._wait_until_element_is_visible(self.__confirm_element)

    def get_confirmation_message(self) -> str:
        return super()._get_text(self.__confirm_element, 4)

    def add_1st_row(self, food: str):
        super()._click(self._row1_edit_button)
        super()._wait_until_element_tobe_clickable(self.__row_1_input_element)
